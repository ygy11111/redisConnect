...
//        redisClient.SortedSetOperate();
    ...
    private void keyOperate() {
        ...
        System.out.println("查看key001的剩余生存时间：" + jedis.ttl("key001"));
        // 查看key所储存的值的类型
        System.out.println("查看key001所储存的值的类型："+jedis.type("key001"));
    ...
    private void StringOperate() {
        ...
        // 设置key的有效期，并存储数据
        System.out.println("新增key303，并指定过期时间为2秒" + shardedJedis.setex("key303", 2, "value303"));
    ...
    private void ListOperate () {
        ...
        shardedJedis.lpush("numberlists", "4");
        ...
        System.out.println("所有元素-numberlists：" + shardedJedis.lrange("numberlists", 0, -1));
        System.out.println("返回排序后的结果-numberlists：" + shardedJedis.sort("numberlists", sortingParams));
        System.out.println("子串-第二个开始到结束：" + shardedJedis.lrange("stringlists", 1, -1));
        System.out.println("获取下标为2的元素：" + shardedJedis.lindex("numberlists", 2) + "\n");
    }
    ...
    private void SetOperate() {
        ...
        System.out.println("sets1中添加元素element001：" + jedis.sadd("sets1", "element1"));
        System.out.println("sets1中添加元素element002：" + jedis.sadd("sets1", "element2"));
        System.out.println("sets1中添加元素element003：" + jedis.sadd("sets1", "element3"));
        System.out.println("sets2中添加元素element002：" + jedis.sadd("sets2", "element2"));
        System.out.println("sets2中添加元素element003：" + jedis.sadd("sets2", "element3"));
        System.out.println("sets2中添加元素element004：" + jedis.sadd("sets2", "element4"));
